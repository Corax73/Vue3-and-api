<template>
    ...
    <div class="create-task" ref="form">
        <div>
            ...
            <p><input type="textarea" v-model.trim='descriptions'></p>
            <label for="importance">Importance</label>
            <p><input type="number" v-model.trim='importance' min="1" max="5"></p>
            <label for="implementation">Implementation</label>
            <p><input type="number" v-model.trim='implementation' min="0" max="1"></p>
